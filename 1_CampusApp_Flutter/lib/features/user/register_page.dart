...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      await NetworkClient.post('/user/register', body: {
              ...
              child: GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInput(controller: _accountCtrl, hint: '请输入学号或手机号'),
                    const SizedBox(height: 20),
                    _buildInput(
                        controller: _passwordCtrl, hint: '设置密码', obscure: true),
                    const SizedBox(height: 20),
                    _buildInput(
                        controller: _confirmCtrl, hint: '确认密码', obscure: true),

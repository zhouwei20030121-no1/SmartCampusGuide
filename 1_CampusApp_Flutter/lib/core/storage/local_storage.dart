...
class LocalStorage {
  ...
  static Future<void> saveGuideContent(
  ...
  static Future<Map<String, dynamic>?> getGuideContent(
    int spotId, {
    String language = 'zh',
  }) async {
    final db = await database;
